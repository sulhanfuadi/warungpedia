  ...
  const handleLogin = async (e: FormEvent) => {
    ...
    try {
      ...
      if (sellerError || !seller || seller.role !== "admin") {
        ...
        throw new Error(
          "Akses ditolak. Email ini tidak terdaftar sebagai admin platform."
        );
      }
    ...
    <div className="min-h-screen bg-[#1a1a1a] flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Login untuk akses dashboard admin</p>
        </div>
        ...
        <div className="bg-[#2a2a2a] rounded-2xl shadow-2xl p-8 border border-[#3a3a3a]">
          ...
          <div className="mt-6 p-4 bg-[#1a1a1a] rounded-lg border border-[#3a3a3a]">
            <p className="text-sm text-gray-400 mb-2">
              <strong className="text-white">Demo Account:</strong>
            </p>
